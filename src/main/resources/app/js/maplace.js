	...
	p = function () {
		...
		e.prototype.create_objMap =
			function () {
				...
				a = 0;
				for (b in this.o.styles) this.o.styles.hasOwnProperty(b) && (a++, this.oMap.mapTypes.set("map_style_" + a, new f.maps.StyledMapType(this.o.styles[b], {
					name: b
		...
		e.prototype.create_objPoint = function (a) {
			...
			a.image && (a.icon = new f.maps.MarkerImage(a.image, new f.maps.Size(a.image_w || 32, a.image_h || 32), new f.maps.Point(0, 0), new f.maps.Point(image_w / 2, image_h / 2)));
			return a
		};
		...
		e.prototype.add_dragEv =
			function (a, b, c) {
				...
				f.maps.event.addListener(c, "drag", function (e) {
					...
					if (g) {
						for (var k = d[g].getPath().getArray(), h = [], l = 0; l < k.length; ++l) h[l] = a === l ? new f.maps.LatLng(e.lat(), e.lng()) : new f.maps.LatLng(k[l].lat(), k[l].lng());
		...
		e.prototype.create = {
			...
			circle: function () {
				...
				for (a = 0; a < this.ln; a++) b = this.create_objPoint(a), "circle" ==
					b.type && (c = this.create_objCircle(b), b.visible || (c.draggable = b.draggable), d = new f.maps.Circle(c), this.add_circleEv(a, c, d), this.circles[a] = d), b.type = "marker", this.create.marker.call(this, a, b, d)
			},
			polyline: function () {
			...
			directions: function () {
				var a = this,
					b, c, d, e, r, k = [],
					h = 0;
				for (b = 0; b < this.ln; b++) c = this.create_objPoint(b), 0 === b ? e = c.position : b === this.ln - 1 ? r = c.position : (d = !0 === this.o.locations[b].stopover ? !0 : !1, k.push({
					location: c.position,
					stopover: d
		...
		e.prototype.ViewOnMap = function (a) {
			if (a === this.view_all_key) this.o.beforeViewAll(), this.current_index = a, 0 < this.o.locations.length && this.o.generate_controls && this.current_control && this.current_control.activateCurrent && this.current_control.activateCurrent.apply(this, [a]), this.oMap.fitBounds(this.oBounds),
