...
(function (factory) {
	...
	var $keyboard = $.keyboard = function (el, options) {
		...
		base.startup = function () {
			...
			if (o.lockInput) {
				base.$preview.addClass(kbcss.locked).attr({
					'readonly': 'readonly'
				});
			}
			...
			base.$allKeys = base.$keyboard.find('button.' + kbcss.keyButton)
				...
				.bind(o.keyBinding.split(' ').join(base.namespace + ' ') + base.namespace + ' ' + $keyboard.events.kbRepeater, function (e) {
					...
					var action, $key,
						...
						txt = $keys.map(function () {
							return $(this).attr('data-curtxt');
						}).get(),
				...
				.bind('mouseenter mouseleave touchstart '.split(' ').join(base.namespace + ' '), function (e) {
					...
					var $this = $(this),
						...
						txt = ($keys.length ? $keys.map(function () {
							return $(this).attr('data-curtxt') || '';
						}).get() : '') || [$this.find('.' + kbcss.keyText).text()];
		...
		base.buildKeyboard = function (name, internal) {
			...
			if ((internal && o.layout === 'custom') || !$keyboard.layouts.hasOwnProperty(o.layout)) {
				o.layout = 'custom';
				$keyboard.layouts.custom = o.customLayout || {
					'normal': ['{cancel}']
				};
			}
